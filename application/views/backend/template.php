...
<head>
	...
	<title>BIBLIOTECA - <?php echo $title; ?></title>
...
<div class="wrapper">
	...
	<header class="main-header">
		...
		<a href="<?php echo base_url(); ?>backend/dashboard" class="logo">
			...
			<span class="logo-mini"><b>UNAP</b></span>
			<!-- logo for regular state and mobile devices -->
			<span class="logo-lg"><b>BIBLIOTECA 8</b></span>
		</a>
		...
		<nav class="navbar navbar-static-top">
			...
			<div class="navbar-custom-menu">
				<ul class="nav navbar-nav">
		            ...
		            <li>
						<a href="<?php echo base_url(); ?>backend/auth/logout" title="Cerrar Sesion" id="logout"><span>Cerrar sesion</span>
